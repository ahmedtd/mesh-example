...
type PodCertificateProjectionApplyConfiguration struct {
	...
	// requests.
	PKCS10RequestParameters *PKCS10RequestParameterSpecApplyConfiguration `json:"pkcs10RequestParameters,omitempty"`
}
...
// WithPKCS10RequestParameters sets the PKCS10RequestParameters field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the PKCS10RequestParameters field is set to the value of the last call.
func (b *PodCertificateProjectionApplyConfiguration) WithPKCS10RequestParameters(value *PKCS10RequestParameterSpecApplyConfiguration) *PodCertificateProjectionApplyConfiguration {
	b.PKCS10RequestParameters = value
	return b
}
