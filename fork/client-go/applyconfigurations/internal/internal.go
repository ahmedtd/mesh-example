  ...
  map:
    ...
    - name: uid
      type:
        scalar: string
    elementRelationship: atomic
- name: io.k8s.api.core.v1.PKCS10RequestParameterSpec
  map:
    fields:
    - name: dns
      type:
...
- name: io.k8s.api.core.v1.PodCertificateProjection
  map:
    ...
    - name: maxExpirationSeconds
      type:
        scalar: numeric
    - name: pkcs10RequestParameters
      type:
        namedType: io.k8s.api.core.v1.PKCS10RequestParameterSpec
    - name: signerName
      type:
        scalar: string
