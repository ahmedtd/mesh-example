...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PKCS10RequestParameterSpec) DeepCopyInto(out *PKCS10RequestParameterSpec) {
	*out = *in
	if in.DNS != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PKCS10RequestParameterSpec.
func (in *PKCS10RequestParameterSpec) DeepCopy() *PKCS10RequestParameterSpec {
	if in == nil {
		return nil
	}
	out := new(PKCS10RequestParameterSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PodCertificateProjection) DeepCopyInto(out *PodCertificateProjection) {
	*out = *in
	...
	if in.PKCS10RequestParameters != nil {
		in, out := &in.PKCS10RequestParameters, &out.PKCS10RequestParameters
		*out = new(PKCS10RequestParameterSpec)
		(*in).DeepCopyInto(*out)
	}
	return
