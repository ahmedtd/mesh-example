...
func (m *PodCertificateRequestSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.UnverifiedPKCS10Request != nil {
		i -= len(m.UnverifiedPKCS10Request)
		copy(dAtA[i:], m.UnverifiedPKCS10Request)
		i = encodeVarintGenerated(dAtA, i, uint64(len(m.UnverifiedPKCS10Request)))
		i--
		dAtA[i] = 0x62
	}
...
func (m *PodCertificateRequestSpec) Size() (n int) {
	...
	if m.UnverifiedPKCS10Request != nil {
		l = len(m.UnverifiedPKCS10Request)
		n += 1 + l + sovGenerated(uint64(l))
	}
	return n
}
...
func (this *PodCertificateRequestSpec) String() string {
	...
	s := strings.Join([]string{`&PodCertificateRequestSpec{`,
		...
		`UnverifiedPKCS10Request:` + valueToStringGenerated(this.UnverifiedPKCS10Request) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *PodCertificateRequestSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UnverifiedPKCS10Request", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UnverifiedPKCS10Request = append(m.UnverifiedPKCS10Request[:0], dAtA[iNdEx:postIndex]...)
			if m.UnverifiedPKCS10Request == nil {
				m.UnverifiedPKCS10Request = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
